...
const orderSchema = new mongoose.Schema({
  ...
  payment: {
    ...
    status: { type: String, enum: ['paid', 'pending', 'failed', 'refunded', 'cod'], default: 'pending' },
    ref: { type: String, default: null },
  },
  status: {
    type: String,
    enum: ['pending', 'accepted', 'preparing', 'packed', 'out_for_delivery', 'delivered', 'cancelled', 'refunded'],
    default: 'pending',
  },
