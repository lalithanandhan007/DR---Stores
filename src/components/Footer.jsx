...
export default function Footer() {
              ...
              {[
  {
    icon: Instagram,
    label: 'Instagram',
    href: 'https://www.instagram.com/drstoresvegetableshop/',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    href: 'https://wa.me/8056249349',
  },
  {
    icon: Phone,
    label: 'Call us',
    href: 'tel:+91 94441 02852',
  },
].map((s) => (
  <a
  key={s.label}
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-5 space-y-4">
              <li className="flex items-start gap-3 text-sm text-white/60">
                ...
                <span className="font-light">R4XV+F46, 1, Kelambakkam - Vandalur Rd, Melakottaiyur, Chennai, Tamil Nadu 600127</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-white/60">
                <Phone className="w-4.5 h-4.5 text-secondary shrink-0" />
                <a href="tel:+919000000000" className="font-light hover:text-secondary transition-colors">+91 94441 02852</a>
              </li>
              <li className="flex items-center gap-3 text-sm text-white/60">
                <Mail className="w-4.5 h-4.5 text-secondary shrink-0" />
                <a href="mailto:hello@drstores.in" className="font-light hover:text-secondary transition-colors">lalithanandhan176@gmail.com</a>
              </li>
              <li className="flex items-start gap-3 text-sm text-white/60">
